...
ggplot(datos_20ml, aes(x = Tiempo)) +
  geom_point(aes(y = Volumen_derretido), color = "red") +
  geom_line(aes(y =  modelo(datos_20ml$Valor_inicial, datos_20ml$Tiempo, valores_optimos_20ml)), color = "red") +
  labs(
    x = "Tiempo",
    y = "Volumen Derretido",
    title = "Gráfico de Volumen Derretido vs. Tiempo"
  ) +
  theme_minimal()
```
